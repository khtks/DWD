...
def calculate_fid_given_paths(paths, device=None, batch_size=50, dims=2048, num_workers=8):
    ...
    m1, s1 = compute_statistics_of_path(str(paths[0]), model, batch_size, dims, device, num_workers)
    m2, s2 = compute_statistics_of_path(str(paths[1]), model, batch_size, dims, device, num_workers)
