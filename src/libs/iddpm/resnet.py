...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, get_rep=False) -> Tensor:
    ...
    def forward(self, x: Tensor, get_rep=False) -> Tensor:
        return self._forward_impl(x, get_rep)
...
def resnet18(num_classes: int =1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
...
def resnet34(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], num_classes, pretrained, progress, **kwargs)
...
def resnet101(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3], num_classes, pretrained, progress, **kwargs)
...
def resnet152(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet152', Bottleneck, [3, 8, 36, 3], num_classes, pretrained, progress, **kwargs)
...
def resnext50_32x4d(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], num_classes, pretrained, progress, **kwargs)
...
def resnext101_32x8d(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], num_classes, pretrained, progress, **kwargs)
...
def wide_resnet50_2(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    return _resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], num_classes, pretrained, progress, **kwargs)
...
def wide_resnet101_2(num_classes=1000, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3], num_classes, pretrained, progress, **kwargs)